...
func QueryClusterResourceCost(tenantId, clusterId string,
	start, end, stepSeconds int64) (*types.ClusterResourceCostList, error) {
	...
	clusterResourceCost := make(map[int64]*types.ClusterResourceCost)
...
func parseResourceTotalCost(clusterResourceCost map[int64]*types.ClusterResourceCost, totalCosts map[int64]float64) {
	for timeStamp, v := range totalCosts {
		clusterResourceCost[timeStamp] = &types.ClusterResourceCost{
			Timestamp: timeStamp,
			TotalCost: v,
		}
	}
...
func parseResourceBillingModeCost(clusterResourceCost map[int64]*types.ClusterResourceCost, billingModeCosts map[string]map[int64]float64) {
	for billingMode, cost := range billingModeCosts {
		for timeStamp, v := range cost {
			cost, ok := clusterResourceCost[timeStamp]
			if !ok {
				cost = &types.ClusterResourceCost{
					Timestamp: timeStamp,
				}
			}
			switch billingMode {
...
func parseNodeResourceTotalCost(clusterResourceCost map[int64]*types.ClusterResourceCost, resourceTotalCost map[string]map[int64]float64) {
...
func parseResourceCPUTotalHour(clusterResourceCost map[int64]*types.ClusterResourceCost, cpuTotalHourCount map[int64]float64, stepSeconds int64) {
...
func parseResourceRAMTotalHour(clusterResourceCost map[int64]*types.ClusterResourceCost, ramTotalHourCount map[int64]float64, stepSeconds int64) {
...
func parseResourceCPUUsageHour(clusterResourceCost map[int64]*types.ClusterResourceCost, cpuUsageHourCount map[int64]float64, stepSeconds int64) {
...
func parseResourceRAMUsageHour(clusterResourceCost map[int64]*types.ClusterResourceCost, ramUsageHourCount map[int64]float64, stepSeconds int64) {
...
func convertClusterResourceCostToList(clusterId string, nodeCost map[int64]*types.ClusterResourceCost) *types.ClusterResourceCostList {
	ret := &types.ClusterResourceCostList{
		ClusterId: clusterId,
		Items:     []*types.ClusterResourceCost{},
	}
